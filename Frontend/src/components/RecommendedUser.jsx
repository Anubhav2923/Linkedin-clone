...
const RecommendedUser = ({user}) => {
    ...
    const {data: connectionStatus, isLoading} = useQuery({
        queryKey: ["connectionStatys", user._id],
        queryFn: ()=> axiosInstance.get(`/connections/status/${user._id}`),
    });

    // Send Connection Request route and Mutation Function
    ...
    // Accept Request route and Mutation Function
    ...
    // Reject Request route and Mutation Function
